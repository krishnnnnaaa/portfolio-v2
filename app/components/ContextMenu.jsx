...
export default function ContextMenu({context, setToggleContext}){
    ...
    const [toggleDesktopBg, setToggleDesktopBg] = useState(false)
    const {setToggleDesktopBackground, toggleDesktopBackdround} = useContext(AppStateContext);
    ...
    return(
        <div ref={refContext} style={{top: context.y + "px", left: context.x + "px"}} id="contextMenu" className="w-60 shadow-[0_0_10px_3px_rgba(0,0,0,0.32)] transition-all text-sm px-[5px] py-[10px] bg-[#cecece4d] backdrop-blur-sm rounded-[10px] relative">
            <ul>
