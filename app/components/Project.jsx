...
export default function Project({image, project, description, demo, code}){
    return(
        <div className="w-72 context hover:bg-[#0000006b] transition-all duration-700 hover:-translate-y-2  flex flex-col justify-center items-center rounded-xl px-0 py-4 md:p-4">
